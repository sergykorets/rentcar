      ...
      <div className="container">
        <div className='introduction'>
          <p>Основою цього сайту є <strong><b>Google API</b></strong>. Готелі, кафе та відгуки до них автоматично оновлюються разом з тим, що є на Google картах. Місцезнаходження закладів
            можна подивитися на <strong><b>3D</b></strong> карті. Готелі, які присутні на <strong><b>Booking.com</b></strong> також показуються на цьому сайті. Якщо Ваш заклад відсутній на сайті, то Ви можете його створити в меню "Додати заклад", або зв'язатися зі мною
